...
class TfidfRank(object):
        ...
        for term, values in self.ft_matrix_hum.iteritems():
            ...
            for value in values:
                ...
                if term in self.tf_idf_matrix_hum:
                    ...
                    self.tf_idf_matrix_hum.update({term: {doc_id: normal_tf_idf}})
        # print pprint.pprint(self.tf_idf_matrix_hum)
    ...
    def compute_ran_hum(self, doc_index, terms):
        """Compute tf-idf score of an indexed document.
        ...
        for term in terms:
            term_index = self.vocabulary[term]
            score += self.tf_idf_matrix_hum[term][doc_index]
        return score
